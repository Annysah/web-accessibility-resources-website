...
const WebAccessContent = () => {
  return (
    <div>
      ...
      <Header />
      <main className="max-w-5xl mx-auto pt-12 px-4 md:px-8 lg:px-16">
        ...
        <section className="mb-6">
          ...
          <h3 className="text-lg sm:text-xl font-semibold mb-1">2. Operable</h3>
          <p className="text-base sm:text-lg md:text-xl mb-4 leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl font-semibold mb-1">4. Robust</h3>
          <p className="text-base sm:text-lg md:text-xl mb-4 leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-6">Conclusion</h2>
          <p className="text-base sm:text-lg md:text-xl mb-4 leading-relaxed">
        ...
        <Link href="../blog" className="flex justify-end items-center text-xl text-gray-800 underline">
